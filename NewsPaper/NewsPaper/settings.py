...
# Разрешить регистрацию новых пользователей через почту
ACCOUNT_EMAIL_VERIFICATION = 'mandatory'
ACCOUNT_EMAIL_REQUIRED = True


# Указать страницу входа для неаутентифицированных пользователей
...
CELERY_BEAT_SCHEDULE = {
    'send-weekly-notification': {
        ...
        'schedule': crontab(day_of_week='wednesday', hour=15, minute=15),  # Запуск каждую среду в 12:45
    },
}
